...
export default function BlogError({
  ...
  return (
    <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '32px 16px', textAlign: 'center' }}>
      <div>
        <h1 style={{ fontSize: 28, marginBottom: 12, color: '#003580' }}>Error en Blog</h1>
        <p style={{ color: '#666', marginBottom: 20 }}>Algo salió mal mientras cargábamos las publicaciones.</p>
        <button
          onClick={reset}
